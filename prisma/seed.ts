...
async function main() {
  ...
  const employees = [
    { id: 'demo-employee-1', firstName: 'John', lastName: 'Smith', email: 'john@demo.com', role: 'employee' as const },
    { id: 'demo-employee-2', firstName: 'Lisa', lastName: 'Brown', email: 'lisa@demo.com', role: 'employee' as const },
    { id: 'demo-employee-3', firstName: 'David', lastName: 'Wilson', email: 'david@demo.com', role: 'employee' as const },
    { id: 'demo-employee-4', firstName: 'Anna', lastName: 'Martinez', email: 'anna@demo.com', role: 'employee' as const },
  ];
  ...
  // Create demo posts for social feed
  const posts = [
    {
      id: 'demo-post-1',
      tenantId: 'demo-tenant-1',
  ...
  // Create demo conversations for chat
